                ...
                <div class="container-fluid">
                    <div class="layout-specing">
                        <div class="d-md-flex justify-content-between">
                            <div>
                                <h5 class="mb-0">New Decision</h5>
                            </div>

                            <nav aria-label="breadcrumb" class="d-inline-block mt-4 mt-sm-0">
                                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                                    <li class="breadcrumb-item"><a href="/FLM_NEW/view/curriculum/listcurriculum">List Decision</a></li>

                                    <li class="breadcrumb-item active" aria-current="page">New Decision</li>
                                </ul>
                            </nav>
                        ...
                        <div class="modal-body p-3 pt-4">
                            <form class="mt-4" action="dicisioncontroller" method="post">
                                <div class="row">
                                    <!--                                    <div class="col-md-6">
                                                                            <div class="mb-3">
                                                                                <label class="form-label" style="font-weight: bold;">Decision ID</label>
                                                                                <input style="background-color: #DADADA " name="id" id="id" type="text" class="form-control" value="${d.getDecision_id()}" readonly="">
                                                                            </div>
                                                                        </div>-->
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input name="decision_no"  type="text" class="form-control" value="${d.getDecision_no()}"  required="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input name="decision_name" type="text" class="form-control" value="${d.getDecision_name()}" required="">
                                    ...
                                    <div class="col-md-6" style="display: none">
                                        <div class="mb-3">
                                            ...
                                            <input style="background-color: #DADADA " name="decision_create"  type="date" class="form-control" value="${date}"  readonly="">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <input type="submit" id="submit" name="add" class="btn btn-primary" value="Add new">
                                    </div><!--end col-->
                                </div><!--end row-->
                            </form><!--end form-->
                        </div>
