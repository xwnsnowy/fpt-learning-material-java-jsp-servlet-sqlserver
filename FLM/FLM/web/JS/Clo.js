...
function changeStatus(x, checkbox) {
    ...
    if (confirm('Do you want to change status the clo with CloId:' + x) === true) {
        document.getElementById('Clo_id').value = x;
...
function exportTemplate() {
    var headers = ["CLO_Name", "CLO_Decritpion", "Active[0 or 1]"];
    var data = [
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "CloList");
