    ...
    <body>
         <c:if test="${toast == 'true'}">
            <script>
                ...
                window.onload = addToast("Success", "Update PLO_PO successfully!", "success", 5000);
            </script>
        </c:if>
        <!-- Loader -->
        <div id="preloader">
                ...
                <div class="container-fluid">
                    <div class="layout-specing">
                        <div class="d-md-flex justify-content-between">
                            <h5 class="mb-0">PO_PLO Mapping </h5>
                        ...
                        <div class="row">
                            <div class="col-lg-12 mt-4">
                                <div class="table-responsive shadow rounded">
                                    <form action="mappingPLO_PO?Ccode=${c.getCode()}" method="post">
                                        <input name = "Ccode" class="mb-0" value="${c.getCode()} " readonly="" hidden=""/>
                                        <table  class="table table-center bg-white mb-0">
                                            
                                            <thead>
                                                <tr class="headtable" >
                                                    <td colspan="100%"  class="border-bottom p-9" style="background-color:#396cf0;text-align: center;height:60px; color: #ffffff">Mapping POs to PLOs</td>
                                                </tr>
                                                <tr>
                                                    <th class="border-bottom p-3" style="text-align: center" >PLO_PO</th>
                                                        <c:forEach var="ListPo" items="${ListPo}">
                                                        <th class="border-bottom p-3" style="min-width: 120px;text-align: center">${ListPo.po_name}</th>
                                                        </c:forEach>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <c:forEach var="plo" items="${ListPlo}">
                                                   <tr class="ListPLO <c:if test="${plo.getIs_Active() == '0' && sessionScope.acc.getRoleName() != 'ADMIN'}">hidden-row</c:if>">
                                                        ...
                                                        <li class="d-flex justify-content-center" style="text-align: center; ">
                                                            <div class="form-check form-switch">
                                                                <input  class="form-check-input"  type="checkbox" name="mapping${plo.plo_id}_${po.po_id}" value="0" 
