                ...
                <div class="container-fluid">
                    <div class="layout-specing">
                        ...
                        <div class="modal-body p-3 pt-4">
                            <form class="mt-4" action="addsetting" method="post">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" style="font-weight: bold;">Name<span class="text-danger" >*</span></label>
                                            <input name="name" id="name" type="text" class="form-control" placeholder="Name:" required maxlength="15">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input name="value" id="value" type="text" class="form-control" placeholder="Value:" maxlength="15">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input name="displayOrder" id="displayOrder" type="number" min="1" class="form-control" placeholder="Display Order: " required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <input type="submit" id="submit" name="add" class="btn btn-primary" value="Add Setting">
