<%-- 
    Document   : electivesubjectdetail
    Created on : Jul 11, 2023, 8:10:35 AM
    Author     : ADMIN
--%>
                ...
                <div class="container-fluid">
                    <div class="layout-specing">
                        ...
                        <div class="row">
                            ...
                            <form action="electivedetail?action=updatesubject" method="post" class="">
                                <input type="hidden" id="id" name="id"class="form-control" value="${s.id}" required="">
                                <input type="hidden" id="code" name="Ccode"class="form-control" value="${c.code}" required="">
                                <div class="col-md-12">
                                    <div class="mb-3" style="max-width: 50%">
                                        <label class="form-label" >Elective Subject Code<span class="text-danger">*</span></label>
                                        <input id="sName" name="code"class="form-control" value="${s.code}" required="" maxlength="200">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-3" style="max-width: 50%">
                                        <label class="form-label" >Elective Subject Name<span class="text-danger">*</span></label>
                                        <input id="sName" name="name"class="form-control" value="${s.name}" required="" maxlength="200">
                                    </div>
                                </div>
                                <div class="col-md-6 d-flex">
                                    <label class="form-label">Active</label>
                                    <div class="form-check form-switch">
                                        <input style="height: 20px; width: 60px; margin-left:1px" class="form-check-input checkbox-row" type="checkbox" name="active" value="${s.isActive}" <c:if test="${s.isActive == '1'}">checked</c:if>/>
