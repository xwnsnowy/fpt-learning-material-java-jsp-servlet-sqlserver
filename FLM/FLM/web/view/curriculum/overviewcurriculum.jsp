...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" >
        <title>FLM_ OverviewCurriculum</title>
                ...
                <div class="container-fluid">
                    <div class="layout-specing">
                        <div class="d-md-flex justify-content-between">
                            <h5 class="mb-0">Curriculum overview</h5>

                            <nav aria-label="breadcrumb" class="d-inline-block mt-4 mt-sm-0">
                                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                                    <li class="breadcrumb-item"><a href="/FLM_NEW/view/curriculum/listcurriculum">Curriculum</a></li>
                                    <li class="breadcrumb-item">Curriculum Detail</li>
                                    <li class="breadcrumb-item active" aria-current=""><a href="#">Overview</a></li>
                                </ul>
                            </nav>
                        </div>
                            ...
                            <div class="col-12 mt-4">
                                <div class="table-responsive shadow rounded">
                                    <table class="table table-center bg-white mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="p-3">Curriculum Code: </td>
                                                    <td class="p-3">${c.getCode()}</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td class="p-3">English Name:</td>
                                                    <td class="p-3">${c.getEnglish_name()}</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="p-3">${c.getDecision_no()} <c:if test="${c.getDecision_no()!= null}">dated</c:if> ${c.getDecision_date()}</td>
                                                </tr>
