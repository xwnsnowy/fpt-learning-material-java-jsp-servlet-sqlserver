                    ...
                    <div class="layout-specing">
                        ...
                        <div class="row">
                            <div class="col-lg-8 mt-4">
                                ...
                                <form action="addPLOs" method="post" class="mt-4">
                                    <input type="hidden" name="cid" value="${c.curriculum_id}">
                                    <div class="row">
                                        <!--end col-->
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label"> PLO Name</label>
                                                <input name="ploName"  type="text" class="form-control" placeholder="PLO Name:" required="" value="${name}"  maxlength="12">
                                            </div> 
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Curriculum Code</label>
                                                <input name="Ccode"class="form-control" value="${c.getCode()}" readonly="" required=""  maxlength="12" >
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="mb-6">
                                                <label class="form-label"> PLO Description</label>
                                                <textarea name="ploDescription"  type="text" class="form-control" placeholder="PLO Description:" >${discirption}</textarea>
                                            </div> 
                                        </div>
                                        <div class="col-md-6">
                                            <li class="d-flex">
                                        ...
                                        <button type="submit" name='btn' style="margin-top: 20px" class="btn btn-primary">Add PLO</button>
