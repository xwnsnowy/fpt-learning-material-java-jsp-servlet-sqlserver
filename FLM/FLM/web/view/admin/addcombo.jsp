                            ...
                            <div class="col-lg-8 mt-4">
                                ...
                                <form action="combo" method="POST" class="mt-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5"  style="display: flex;margin-bottom:20px">
                                            <label class="form-label" style="font-weight: bold;margin-right:10px;margin-top:5px">Curriculum ID </label>
                                            <input type="text" readonly value="${curriculumid}" style="background-color: #decbcb">     
                                        </div>
                                        </c:if>    
                                        <div class="col-md-10">
                                            <div class="mb-3">
                                                <label class="form-label" style="font-weight: bold">Combo NAME</label>
                                                <input name="groupname" id="groupname" pattern="^[a-zA-Z0-9_:.()ÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚĂĐĨŨƠàáâãèéêìíòóôõùúăđĩũơƯĂ
                                        ...
                                        <button type="submit" name='btnAdd' class="btn btn-primary col-md-10">Add Combo</button>
