                    ...
                    <div class="layout-specing">
                        ...
                        <div class="row">
                            <div class="col-lg-12 mt-4">
                                <!--end row-->
                                <input type="text" value="${Ccode}" name='Ccode'>
                                <form action="plo?action=addlist&Ccode=${c.code}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="table-responsive shadow rounded">
                                            <table class="table table-center bg-white mb-0">
                                                <thead>
                                                    ...
                                                    <tr>
                                                        <th class="border-bottom p-3" style="min-width: 90px;">PLO ID</th>
                                                        ...
                                                        <th class="border-bottom p-3" style="max-width: 50px;">Curriculum ID</th>
                                                ...
                                                <c:forEach var="plo" items="${validPloList}">
                                                    <tr>
                                                        <td class="border-bottom p-3" style="min-width: 100px;">${plo.getPlo_id()}</td>
                                                        <td class="border-bottom p-3" style="min-width: 110px;">${plo.getPlo_name()}</td>
                                                        <td class="border-bottom p-3" style="min-width: 110px;">${plo.getPlo_description()}</td>
                                                        <td class="border-bottom p-3" style="min-width: 110px;">${plo.curriculum_code}</td>
                                                        <td class="border-bottom p-3" style="min-width: 110px;">${plo.is_Active}</td>
                                                        <td class="border-bottom p-3" style="min-width: 110px;">${plo.created_by}</td>
                                                        <td class="border-bottom p-3" style="min-width: 110px;">${plo.created_at}</td>
                                                    </tr>
                                                </c:forEach>
                                            </table>
                                            <table class="table table-center bg-white mb-0">
                                                <thead>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="border-bottom p-3" style="max-width: 50px;">Curriculum_ID</th>
                                                        <th class="border-bottom p-3" style="max-width: 50px;">Active</th>
                                                        <th class="border-bottom p-3" style="max-width: 50px;">Create_by</th>
                                                        <th class="border-bottom p-3" style="max-width: 50px;">Create_at</th>
                                                        <!--<th class="border-bottom p-3" style="min-width: 90px;">Create_At</th>-->
                                                ...
                                                <c:forEach var="o" items="${invalidPloList}">
                                                    <tr>
                                                        <td class="border-bottom p-3" style="min-width: 100px;">${o.getPlo_id()}</td>
                                                        <td class="border-bottom p-3" style="min-width: 110px;">${o.getPlo_name()}</td>
                                                        <td class="border-bottom p-3" style="min-width: 110px;">${o.getPlo_description()}</td>
                                                        <td class="border-bottom p-3" style="min-width: 110px;">${o.curriculum_code}</td>
