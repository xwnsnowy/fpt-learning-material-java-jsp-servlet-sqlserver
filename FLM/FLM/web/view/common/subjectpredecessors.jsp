...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" >
        <title>Subject Predecessors</title>
                        ...
                        <div >
                            <div class="row" >
                                <div class="col-12" style="max-width:95%;margin: auto">
                                    <h2 style="margin-top:10px; font-family: sans-serif">Show Learning Path of a Subject</h2>
                                    <form action="subjectpredecessors" method="POST">
                                            ...
                                            <table class="table table-center table-padding mb-0" >
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="border-bottom p-3" style="background-color:#396cf0; color: #ffffff">Subject Predecessors</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr >
