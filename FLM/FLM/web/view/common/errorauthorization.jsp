<%-- 
    Document   : errorAuthorization
    Created on : 23-06-2023, 14:19:50
    Author     : user
--%>
...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="../../assets/images/flm-dark.png">
         <style>@import url("https://fonts.googleapis.com/css?family=Dosis:300,400,700,800");
    ...
    <body class="permission_denied">
        ...
        <div class="denied__wrapper">
            <h1>401</h1>
            <h3>You do not have <span>ACCESS</span> to access this website.</h3>
            ...
            <a href="/FLM_NEW/view/common/login"><button class="denied__link">Back to Login</button></a>
        </div>
    </body>
</html>
