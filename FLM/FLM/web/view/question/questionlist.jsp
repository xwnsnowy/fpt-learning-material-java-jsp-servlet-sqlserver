    ...
    <body>
        <c:if test="${sessionScope.toast == 'true'}">
            ...
            <script>
                ...
                window.onload = addToast("Success", "Add New Question Successfully!", "success", 5000);
            </script>
        </c:if>
        <!-- Loader -->
        <div id="preloader">
                ...
                <div class="container-fluid">
                    <div class="layout-specing">
                        <div class="d-md-flex justify-content-between">
                            <h5 class="mb-0">List Question</h5>
                        ...
                        <div class="row">
                            <form action="/FLM_NEW/view/question/question" method="post">
                                <div class="mb-2">
...
<!--                            <form action="/FLM_NEW/view/question/question" method="get">
                                <button type="submit" name="btn-New" value="new" class="btn btn-pills btn-warning"> New Question </button> 
                            </form>-->
                                    ...
                                    <table class="table table-center bg-white mb-0">
                                        <c:if test="${List != null}" >
                                            <thead style="background-color: #369cf0">
                                                <tr>
                                                    ...
                                                    <th class="border-bottom p-3" >Session_no</th>
                                        ...
                                        <tbody>
                                            <c:forEach var="item" items="${List}">
                                                <tr>
                                                    <td class="p-3">${item.getQuestion_id() }</td>
                                                    <td class="p-3">${item.getSession_id()}</td>
                                                    <td class="p-3">${item.getName()}</td>
                                                    <td class="p-3">${item.getDetail()}</td>
                                                    <c:if test="${sessionScope.acc.getRoleName() == 'ADMIN' || sessionScope.acc.getRoleName()=='CRDD STAFF'  ||  sessionScope.acc.getRoleName()=='CRDD HEAD'}">
                                                    <td class="p-3"><a href="/FLM_NEW/view/question/question?edit=1&&id=${item.getQuestion_id()}"><i class="uil uil-pen"></i></a></td>
                                                    </c:if>
