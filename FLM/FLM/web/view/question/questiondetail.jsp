...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" >
        <title>FLM Question Detail</title>
    ...
    <body>
        <c:if test="${sessionScope.toast == 'true'}">
            ...
            <script>
                ...
                window.onload = addToast("Success", "Update question Successfully!", "success", 5000);
            </script>
        </c:if>
        <!-- Loader -->
        <div id="preloader">
                ...
                <div class="container-fluid">
                    <div class="layout-specing">
                        <div class="d-md-flex justify-content-between">
                            <div>
                                <h5 class="mb-0">Question Detail</h5>
                            </div>
...
<!--                            <nav aria-label="breadcrumb" class="d-inline-block mt-4 mt-sm-0">
                        ...
                        <div class="modal-body p-3 pt-4">
                            <form class="mt-4" action="/FLM_NEW/view/question/question" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-md-6" style="display: none">
                                        <div class="mb-3">
                                            ...
                                            <input name="id" id="id" type="text" class="form-control" value="${q.getQuestion_id()}" readonly="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input name="name" id="id" type="text" class="form-control" value="${q.getName()}" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label" style="font-weight: bold;">Details</label>
                                            <textarea name="detail" id="comments" rows="4" class="form-control" >${q.getDetail()}</textarea>
                                        </div>
                                    </div>
