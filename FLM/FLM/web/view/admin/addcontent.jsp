                    ...
                    <div class="layout-specing">
                        <div class="d-md-flex justify-content-between">
                            ...
                            <nav aria-label="breadcrumb" class="d-inline-block mt-4 mt-sm-0" style="margin-bottom:10px">
                                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">New Combo</li>
                                </ul>
                            </nav>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-8 mt-4">
                                <h3>Add New Content Group</h3>
                                <form action="contentgroup?action=newcontentgroup&curriculumid=${curriculumid}" method="POST" class="mt-4">
                                    ...
                                    <div class="row"> 
                                        <div class="col-md-10">
                                            <div class="mb-3">
                                                ...
                                                <input name="contentgroupname" value="${contentgroupname}" id="contentgroupname" pattern="^[a-zA-Z0-9_:.()ÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚĂĐĨŨƠàáâãèéêìíòóôõùúăđĩũơƯĂ
                                        ...
                                        <button type="submit" name='btnAddContentGroup' class="btn btn-primary col-md-10">Add Content Group</button>
